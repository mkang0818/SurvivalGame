...
public class SpawnLv4 : MonoBehaviour
{
    public InGameManager InGameManager;
    int Stage = 0;

    public GameObject Lv4Monster;
    ...
    IEnumerator spawnMosnter()
    {
        while (true)
        {
            ...
            GameObject monster = Instantiate(Lv4Monster, new Vector3(randXPos, 0, randZPos), Quaternion.identity);
