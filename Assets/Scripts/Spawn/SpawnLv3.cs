...
public class SpawnLv3 : MonoBehaviour
{
    public InGameManager InGameManager;
    int Stage = 0;

    public GameObject Lv3Monster;
    ...
    IEnumerator spawnMosnter()
    {
        while (true)
        {
            ...
            GameObject monster = Instantiate(Lv3Monster, new Vector3(randXPos, 0, randZPos), Quaternion.identity);
